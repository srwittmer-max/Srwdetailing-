...
const LOCATION = "Tampa & Wesley Chapel, FL";
...
const FAQS = [
  {
    ...
    a: "Yes. We offer fully mobile detailing services throughout Tampa and Wesley Chapel, bringing our premium studio-level care directly to your driveway or garage."
  },
  {
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <FadeIn>
              ...
              <div className="space-y-6 text-slate-400 text-lg leading-relaxed">
                <p>
                  SRW Detailing isn't just about washing cars; it's about restoration and preservation. Based in the heart of Tampa and Wesley Chapel, we bring luxury detailing to your doorstep.
                </p>
                <p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-start">
            ...
            <FadeIn className="relative z-10 max-w-xl">
              ...
              <p className="text-slate-400 text-lg mb-10">
                Contact us today for a custom quote or to schedule your premier detailing service in Tampa or Wesley Chapel.
              </p>
